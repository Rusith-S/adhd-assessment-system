...
const Puzzle_5 = ({ imageOptions, text, audio }) => {
  const gridSize = 5;
  const pieceSize = 110;
  ...
  console.log("Puzzle_5: received selectedImage =", selectedImage);
  ...
  // Play audio on start (if provided) then start the game.
  ...
  return (
    <div className="flex flex-col items-center" onMouseMove={handleMouseMove}>
      ...
      {/* Two Columns: Left displays complete puzzle; right displays shuffled puzzle */}
      <div className="flex flex-row gap-8 mt-10">
        {/* Left column: Completed Puzzle */}
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            className="grid grid-cols-5 gap-1 border border-gray-400"
