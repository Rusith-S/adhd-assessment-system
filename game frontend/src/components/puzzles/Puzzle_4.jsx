...
const Puzzle_4 = ({ imageOptions, text, audio }) => {
  const gridSize = 4;
  const pieceSize = 130;
  ...
  console.log("Puzzle_4: received selectedImage =", selectedImage);
  ...
  // Play audio on start then start the game.
    ...
    <div className="flex flex-col items-center" onMouseMove={handleMouseMove}>
      ...
      <div className="flex flex-row gap-8 mt-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div
            className="grid grid-cols-4 gap-1 border border-gray-400"
